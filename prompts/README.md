...
This folder contains copyable prompts for operations managers who are new to AI.
...
- [Data and reporting](data-and-reporting.md)
- [Bid and opportunity support](bid-and-opportunity-support.md)
- [Governance-safe use](governance-safe-use.md)
