...
| [Prompt library](prompts/README.md) | Copyable prompts for non-technical operations managers. | Managers who want quick wins |
...
- Generates draft briefs (pre-shift huddle, handoff, after-action).
