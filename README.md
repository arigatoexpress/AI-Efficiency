...
| [Operations Decision Lab](starter-projects/operations-decision-lab/README.md) | **Offline deterministic evaluator** | Produces leakage-safe package-volume baseline evidence and independently checks supplied synthetic plans against hard constraints. No route generation, plan ranking, or dispatch; every output is advisory evidence for human review. |
